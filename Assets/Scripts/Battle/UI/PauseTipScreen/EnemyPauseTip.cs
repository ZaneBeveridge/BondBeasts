...
public class EnemyPauseTip : PauseTip
{
    [Header("Enemy Pause Tip References")]
    ...
    public override void OpenTip()
    {
        ...
        Monster mon = bManager.enemyMonsterController.currentMonster;
        ...
        for (int i = 0; i < statTexts.Count; i++)
        {
            ...
            {
                case 0:
                    itemPassivesAmount = (int)bManager.enemyMonsterController.enemyBattleBuffManager.GetStatsFromItemsPassives(EffectedStat.Oomph);
                    break;
                case 1:
                    itemPassivesAmount = (int)bManager.enemyMonsterController.enemyBattleBuffManager.GetStatsFromItemsPassives(EffectedStat.Guts);
                    break;
                case 2:
                    itemPassivesAmount = (int)bManager.enemyMonsterController.enemyBattleBuffManager.GetStatsFromItemsPassives(EffectedStat.Juice);
                    break;
                case 3:
                    itemPassivesAmount = (int)bManager.enemyMonsterController.enemyBattleBuffManager.GetStatsFromItemsPassives(EffectedStat.Edge);
                    break;
                case 4:
                    itemPassivesAmount = (int)bManager.enemyMonsterController.enemyBattleBuffManager.GetStatsFromItemsPassives(EffectedStat.Wits);
                    break;
                case 5:
                    itemPassivesAmount = (int)bManager.enemyMonsterController.enemyBattleBuffManager.GetStatsFromItemsPassives(EffectedStat.Spark);
                    break;
            }

            val = val + bManager.enemyMonsterController.enemyBattleBuffManager.slotValues[i] + itemPassivesAmount;
